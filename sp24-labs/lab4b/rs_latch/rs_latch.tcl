...
# Define cell
define_cell \
       -input { top_in_n top_in_p} \
       -output { top_out_n top_out_p } \
       -pinlist { top_in_n top_in_p top_out_n top_out_p } \
...
write_library -overwrite rs_latch_new${PVT}.lib

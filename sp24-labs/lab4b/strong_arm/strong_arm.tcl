...
define_cell \
       -clock { clock } \
       -input { input_n input_p} \
       -output { output_n output_p } \
       -pinlist { clock input_n input_p output_n output_p} \
...
write_library -overwrite strong_arm${PVT}.lib
